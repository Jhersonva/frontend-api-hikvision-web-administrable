<!--src/components/layout/RegisterForm.vue-->
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-900 px-4">
    <div class="w-full max-w-md bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-700">
      <!-- Logo + Título -->
      <div class="text-center mb-6">
        <div class="w-25 h-25 mx-auto mb-3 flex items-center justify-center rounded-full border-4 border-blue-600 bg-gray-700 shadow-lg">
        ...
        <p class="text-gray-400">Regístrate y comienza a gestionar el sistema</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        <div>
          <input
            ...
            type="text"
            placeholder="Usuario"
            class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600"
          />
        </div>
        <div>
          <input
      ...
      <p class="mt-6 text-sm text-center text-gray-400">
        ¿Ya tienes cuenta?
        <router-link to="/login" class="text-red-500 font-medium hover:underline">
          Inicia sesión aquí
        </router-link>
      </p>
    </div>
